...
Deno.serve(async (req: Request) => {
  ...
  const staticPages = [
    ...
    { loc: `${SITE}/free-puzzle-games/`, changefreq: "weekly", priority: "0.8",  lastmod: today },
    { loc: `${SITE}/free-racing-games/`, changefreq: "weekly", priority: "0.8",  lastmod: today },
    { loc: `${SITE}/free-sports-games/`, changefreq: "weekly", priority: "0.8",  lastmod: today },
    { loc: `${SITE}/free-action-games/`, changefreq: "weekly", priority: "0.8",  lastmod: today },
    { loc: `${SITE}/free-arcade-games/`, changefreq: "weekly", priority: "0.8",  lastmod: today },
    { loc: `${SITE}/free-car-games/`, changefreq: "weekly", priority: "0.8",  lastmod: today },
